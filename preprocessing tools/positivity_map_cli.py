"""CLI for generating positivity probability maps from nucleus channel images.

Processes all image files in a given folder.

Examples:
    python -m solar.cli.positivity_map_nuc_cli /path/to/nucleus_folder /path/to/output
    python -m solar.cli.positivity_map_nuc_cli /path/to/nucleus_folder /path/to/output --tile_free
    python -m solar.cli.positivity_map_nuc_cli /path/to/nucleus_folder /path/to/output --debug --tile_size 256 --tile_overlap 64
"""
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Generate positivity probability maps for all files in a nucleus channel folder.")
    parser.add_argument("input_folder", type=str, help="Path to the folder containing nucleus channel images.")
